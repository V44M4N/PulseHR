    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <Tabs defaultValue="auth">
        ...
        <TabsContent value="auth" className="card-surface p-6 mt-4 space-y-4">
          {[["Single Sign-On (SSO)","SAML 2.0 / OAuth via Google, Okta",true],["Multi-factor authentication","Mandatory for admin roles",true],["IP allowlisting","Restrict admin access to office IPs",false],["Session timeout (30m)","Auto sign-out after inactivity",true],["Password rotation (90d)","Enforce periodic password change",false]].map(([t,d,v]: any) => (
